          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-start">
                ...
                <span className="text-sm sm:text-base text-slate-700">Industry-certified instructors with real-world experience</span>
              </div>
              <div className="flex items-start">
                <CheckCircle className="text-green-500 mr-3 h-5 w-5 flex-shrink-0 mt-0.5" />
                <span className="text-sm sm:text-base text-slate-700">Hands-on projects using the latest software and datasets</span>
              </div>
              <div className="flex items-start">
                <CheckCircle className="text-green-500 mr-3 h-5 w-5 flex-shrink-0 mt-0.5" />
                <span className="text-sm sm:text-base text-slate-700">Flexible learning options: online, hybrid, and in-person</span>
              </div>
              <div className="flex items-start">
                <CheckCircle className="text-green-500 mr-3 h-5 w-5 flex-shrink-0 mt-0.5" />
                <span className="text-sm sm:text-base text-slate-700">Career placement assistance and networking opportunities</span>
              </div>
            </div>
          </div>
        </div>
