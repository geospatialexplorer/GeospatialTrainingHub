      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="font-bold text-lg sm:text-xl">GeoSpatial Academy</span>
            </div>
          ...
          <div>
            <h4 className="font-semibold text-base sm:text-lg mb-3 sm:mb-4">Popular Courses</h4>
            <ul className="space-y-2">
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors text-sm sm:text-base">GIS Fundamentals</a></li>
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors text-sm sm:text-base">Remote Sensing</a></li>
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors text-sm sm:text-base">Python for GIS</a></li>
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors text-sm sm:text-base">Web GIS Development</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-800 mt-8 sm:mt-12 pt-6 sm:pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-slate-400 text-xs sm:text-sm text-center md:text-left">&copy; 2024 GeoSpatial Academy. All rights reserved.</p>
